...
struct PlayerObjects FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const CommonObjectInfo *mainSelected() const {
    return GetPointer<const CommonObjectInfo *>(VT_MAINSELECTED);
  }
  const flatbuffers::Vector<flatbuffers::Offset<CommonObjectInfo>> *allSelected() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<CommonObjectInfo>> *>(VT_ALLSELECTED);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_PLAYERID) &&
           VerifyOffset(verifier, VT_MAINSELECTED) &&
           verifier.VerifyTable(mainSelected()) &&
           VerifyOffset(verifier, VT_ALLSELECTED) &&
           verifier.VerifyVector(allSelected()) &&
           verifier.VerifyVectorOfTables(allSelected()) &&
...
struct PlayerObjectsBuilder {
  ...
  void add_mainSelected(flatbuffers::Offset<CommonObjectInfo> mainSelected) {
    fbb_.AddOffset(PlayerObjects::VT_MAINSELECTED, mainSelected);
  }
  void add_allSelected(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<CommonObjectInfo>>> allSelected) {
    fbb_.AddOffset(PlayerObjects::VT_ALLSELECTED, allSelected);
  }
...
inline flatbuffers::Offset<PlayerObjects> CreatePlayerObjects(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint8_t playerId = 0,
    flatbuffers::Offset<CommonObjectInfo> mainSelected = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<CommonObjectInfo>>> allSelected = 0,
  ...
  builder_.add_allSelected(allSelected);
...
inline flatbuffers::Offset<PlayerObjects> CreatePlayerObjectsDirect(
    ...
    uint8_t playerId = 0,
    flatbuffers::Offset<CommonObjectInfo> mainSelected = 0,
    const std::vector<flatbuffers::Offset<CommonObjectInfo>> *allSelected = nullptr,
  ...
  return AOC::CreatePlayerObjects(
      ...
      playerId,
      mainSelected,
      allSelected ? _fbb.CreateVector<flatbuffers::Offset<CommonObjectInfo>>(*allSelected) : 0,
